...
public final class TOTPData {
	...
	/**
	 * Represents the identifier for the organization or service issuing the Time-Based One-Time Password (TOTP).
	 *
	...
	/**
	 * Represents the username or account identifier for which the TOTP data is associated.
	...
	/**
	 * A byte array storing the secret key used for generating Time-based One-Time Passwords (TOTP).
