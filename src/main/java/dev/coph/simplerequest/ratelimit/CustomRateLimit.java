...
/**
 * Annotation to define additional rate limiting configurations for a specific method or endpoint-discovery.
...
public @interface CustomRateLimit {
     ...
     * for the annotated method or endpoint-discovery. This value is intended to be used for
    ...
    /**
     * Specifies the rate-limiting algorithm to be used for the associated method or endpoint-discovery.
